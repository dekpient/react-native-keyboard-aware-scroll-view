...
function KeyboardAwareHOC(
  ...
  return class
    ...
    scrollToFocusedInput = (
      ...
      if (!this.mountedComponent || !reactNode) {
        return
      }
    ...
    // TextInput.State.currentlyFocusedField deprecated as of RN 0.63 and should use currentlyFocusedInput
    _getCurrentlyFocusedField = () => TextInput.State.currentlyFocusedInput ? findNodeHandle(TextInput.State.currentlyFocusedInput()) : TextInput.State.currentlyFocusedField()
    ...
    _updateKeyboardSpace = (frames: Object) => {
      ...
      if (this.props.enableAutomaticScroll) {
        ...
        this.setState({ keyboardSpace })
        const currentlyFocusedField =  this._getCurrentlyFocusedField()
        const responder = this.getScrollResponder()
                  ...
                  if (Platform.OS === 'ios') {
                    if (
                      ...
                      this._scrollToFocusedInputWithNodeHandle(
                        this._getCurrentlyFocusedField()
                      )
                    }
                  } else {
